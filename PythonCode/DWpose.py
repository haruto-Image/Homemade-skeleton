...
def main():
    ...
    # 既定パス（必要に応じて書き換え）
    ap.add_argument("--video", default=r"C:\Users\_s2520798\Documents\1.研究\入出力映像\output\0817[三野さん動画]\test_1280_1280.mp4")
    ...
    while True:
        ...
        kps133 = pose.infer_keypoints133(frame, box)
        ...
        # 3) 骨格の描画
        canvas = draw_skeleton(canvas, kps133, EDGES)
